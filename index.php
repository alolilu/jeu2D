...
<head>
    ...
    <link rel="stylesheet" href="../monJeu/assets/styles.css">
    <title>Mon Jeu</title>
...
<canvas id="myCanvas"></canvas>
    ...
    <script type="text/javascript" src="assets/js/nuage.js"></script>
    <script type="text/javascript" src="assets/js/dirt.js"></script>
